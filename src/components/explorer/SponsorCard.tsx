...
import { MapPin, Target, MessageCircle, Search, Star, Building2, CornerUpRight } from 'lucide-react';
        ...
        <div className="absolute bottom-0 left-0 right-0 p-4">
          <div className="flex items-center space-x-3">
            ...
            <div className="text-white">
              <h3 className="text-lg font-semibold">{sponsor.company}</h3>
              <p className="text-sm text-white/90">{sponsor.industry}</p>
            </div>
          </div>
      ...
      <div className="p-4 space-y-4">
        ...
        <div className="space-y-2">
          ...
          <div className="flex items-center">
            ...
            <span className="text-gray-600">{sponsor.industry}</span>
          </div>
          <div className="flex items-center">
            <Target className="w-4 h-4 mr-2 text-green-500" />
            <span className="text-gray-600">{sponsor.interests[0]}</span>
          </div>
          <div className="flex items-center">
            <Search className="w-4 h-4 mr-2 text-amber-500" />
            <span className="text-gray-600">{sponsor.requirements[0]}</span>
          </div>
        </div>
