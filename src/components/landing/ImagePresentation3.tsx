...
export function ImagePresentation3() {
  return (
    <div className="relative flex flex-col justify-center items-center min-h-screen">
      {/* Fond coloré */}
      <div className="absolute bottom-[-60vh] w-full h-[85vh] bg-[#7C3AED] z-0 p-6 flex flex-wrap">
        ...
        <div className="w-6/12 h-[55.5%] flex flex-col items-start p-4 rounded-lg font-semibold">
         ...
         <div className="flex flex-row space-x-10">
          <button className="inline-block mt-6 px-6 py-2.5 bg-white text-[#7C3AED] font-semibold rounded-lg hover:bg-gray-200">
              Découvrir
          </button>
